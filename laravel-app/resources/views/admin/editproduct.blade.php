          ...
          <div class="card-body">
            ...
            <form action="{{route('updateproduct')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="product_short_desc" name="product_short_desc" value="{{$productinfo->product_short_desc}}" />
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                   <textarea class="form-control" name="product_long_desc" id="product_long_desc" cols="60" rows="10">{{$productinfo->product_long_desc}}</textarea> 
                </div>
              </div>
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-name">Minimium Stock</label>
                <div class="col-sm-10">
