        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('admindashboard') }}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Teknios</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Providers</span>
            </li>

            <li class="menu-item">
              <a href="{{ route('addprovider') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Add Provider</div>
              </a>
            </li>

            <li class="menu-item">
              <a href="{{ route('allproviders') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Daniel</span>
