...
<div class="container">
    <div class="card">
        <h5 class="card-header">Avaliable Product Information</h5>
            ...
            <tbody class="table-border-bottom-0">
              ...
              <tr>
                ...
                <td>
                  ...
                  @if( $product->quantity <=  $product->minimium_stock )
                  <a href="#" class="btn btn-danger">LOW STOCK</a>
                  <a href="#" class="btn btn-danger">{{$product->quantity}}</a>
                  <a href="{{route('calltoprovider', $product->id)}}" class="btn btn-secondary">CALL TO PROVIDER</a>
                  @endif
