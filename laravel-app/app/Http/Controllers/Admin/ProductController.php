    ...
    public function UpdateProduct(Request $request) {
        ...
        $request->validate([
            ...
            Product::findOrFail($productid)->update([
                ...
                'price' => $request->price,
                'quantity' => $request->quantity,
                'minimium_stock' => $request->minimium_stock,
                'slug' => strtolower(str_replace(' ','-', $request->product_name)),
            ]);    
    
            
    
            return redirect()->route('allproducts')->with('message', 'Product info updated Succesfully.');
    }

    public function CallToProvider($id) {
        $productinfo = Product::findOrFail($id);
        return view('admin.buytoprovider', compact('productinfo'));

    }

    public function BuyToProvider(Request $request) {
        ...
        $request->validate([
            ...
            return redirect()->route('allproducts')->with('message', 'Product fill stock succesfully.');
    }
